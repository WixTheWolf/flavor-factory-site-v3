...
const demandSnippets = [
  { family: "Citrus", copy: "Bright, juicy, zesty profiles from clean to punchy." },
  { family: "Vanilla & Cream", copy: "Smooth, rounded directions for dairy, bakery, and indulgent builds." },
  { family: "Mint & Cooling", copy: "Fresh, clean cooling profiles for oral care and confectionery." },
  { family: "Savory & Culinary", copy: "Bold, application-driven savory profiles for snacks and seasoning systems." },
] as const;
const familyDescriptors: Record<string, string> = {
  ...
  "Orchard & Stone Fruit": "Familiar fruit profiles with room to go fresh, baked, spiced, or nostalgic.",
  ...
  "Custom & Signature": "Need something unusual or proprietary? This is where custom development comes in.",
};
    ...
    <section>
      ...
      <div className="finder-surface" style={{ marginTop: 12 }}>
        ...
        <FinderControls
          ...
          onChange={setFilters}
        />
        <p className="section-subtext" style={{ marginTop: 10, marginBottom: 0 }}>
          Need a benchmark match? <a href="/request-samples" style={{ textDecoration: "underline" }}>Request samples.</a>
        </p>
        ...
        <div className="strength-grid two-col" style={{ marginTop: 12 }}>
          {demandSnippets.map((item) => (
            <article className="strength-card" key={item.family} style={{ padding: 18 }}>
