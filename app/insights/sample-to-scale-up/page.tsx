...
export default function Article() {
  return (
    <>
      ...
      <InsightBreadcrumbJsonLd slug="sample-to-scale-up" />
      <ArticleReadTracker slug="sample-to-scale-up" />
      <Header />
      <main>
        ...
        <CTA eyebrow="Ready to Start?" title="First samples in 3-5 days. Production follows the same path." copy="Share your application, base, and label goals. Development and manufacturing are handled by the same team." href="/request-samples" label="Request a Custom Sample" />
      </main>
      <Footer />
    </>
  );
